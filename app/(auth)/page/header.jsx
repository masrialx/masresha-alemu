...
export default function Header() {
  ...
  <motion.div 
    className="p-6 bg-black bg-opacity-50 rounded-xl w-full sm:w-[80%] md:w-[50%] lg:w-[40%] xl:w-[30%] border-4 border-yellow-500 max-w-screen-sm sm:max-w-screen-md"
  ...
  >
    ...
    <p className="text-xl sm:text-2xl mt-2 font-extrabold">I'm a Software Engineer</p>
    ...
    <button onClick={() => handleScroll("contact")} className="mt-4 bg-[#0a192f] px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300 font-extrabold">
      Let's Contact
    </button>
  </motion.div>
</section>
