...
export default function AboutMe() {
  ...
  return (
    ...
    <span className="font-bold text-red-500">Full Stack &amp; AI Engineer</span> with experience building scalable <span className="font-bold text-red-500">SaaS platforms</span>, <span className="font-bold text-red-500">AI agents</span> (OpenClaw, MCP, browser automation, UI agents), and <span className="font-bold text-red-500">LLM-powered automation</span> for international startups. Skilled in backend systems, AI integrations, and end-to-end development — from <span className="font-bold text-red-500">AlphaMail AI</span> and <span className="font-bold text-red-500">GenAI</span> at Agents4Hire to CRM automation at <span className="font-bold text-red-500">AISyncso</span>, interview systems at <span className="font-bold text-red-500">Sapien AI</span>, and <span className="font-bold text-red-500">Kelem Quiz</span> at NileSync. Harvard HSIL Hackathon <span className="font-bold text-red-500">Ethiopia Hub winner</span> and <span className="font-bold text-red-500">Global Top 50 finalist</span>.
  </p>
